// use super::{HttpResponse, HttpRoute};
// use anyhow::Context;
...
// use metered::{measure, HitCount, ResponseTime};
...
//     pub async fn get_api_metrics_for_prometheus(&self, route: &HttpRoute<'_>) -> anyhow::Result<Response<Body>> {
...
//
//         HttpResponse::ok(Body::from(buffer), route.accept_encoding)
//     }
//
//     pub async fn get_api_metrics_as_json(&self, route: &HttpRoute<'_>) -> anyhow::Result<Response<Body>> {
//         HttpResponse::json(&self.registry, route.accept_encoding)
//     }
// }
//
